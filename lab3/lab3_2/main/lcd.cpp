...
void lcd::init() {
    ...
    sendCommand(0x39);  // Function set
    sendCommand(0x14);  // Internal OSC frequency
    sendCommand(0x70);  // Contrast set
    sendCommand(0x56);  // Power/icon/contrast
    sendCommand(0x6C);  // Follower control
